...
private IEnumerator TypewriterEffect(string text)
    ...
    private StoryChoice ParseStoryChoice(string choiceId)
    {
        switch (choiceId.ToLower())
        {
            case "honest":
            case "honesty":
                return StoryChoice.HonestPath;
            case "compassionate":
            case "compassion":
                return StoryChoice.CompassionatePath;
            case "courageous":
            case "courage":
                return StoryChoice.CourageousPath;
            case "logical":
            case "logic":
                return StoryChoice.LogicalPath;
            case "humble":
            case "humility":
                return StoryChoice.HumblePath;
            case "perseverant":
            case "perseverance":
                return StoryChoice.PerseverantPath;
            case "respectful":
            case "respect":
                return StoryChoice.RespectfulPath;
            case "responsible":
            case "responsibility":
                return StoryChoice.ResponsiblePath;
            case "fair":
            case "fairness":
                return StoryChoice.FairPath;
            case "harmonious":
            case "harmony":
                return StoryChoice.HarmoniousPath;
            default:
                return StoryChoice.HonestPath; // Default fallback
        }
    }
